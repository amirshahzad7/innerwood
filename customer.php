...
<body>
    ...
    <div class="box">
        ...
        <p align="center"> <input name="Search" type="submit" value="View All Records"
                onclick=" window.open('process/allcustomer.php','',' scrollbars=yes,menubar=no,width=500, resizable=yes,toolbar=no,location=no,status=no')" />
    </div>
