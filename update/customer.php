 ...
 ?>
    <div class="box">
        ...
        <form method="POST" action="customer.php">
            ...
            <button name="submit3" formaction=""
                onclick=" window.open('../process/allcustomer.php','',' scrollbars=yes,menubar=no,width=500, resizable=yes,toolbar=no,location=no,status=no')">Search
                By Name</button><br><br>
